			...
			<ul>
				...
				<li class="libo">
					<ul>
						...
						<li>
							<ul>
								<li><a href="<?php bloginfo('wpurl');?>/bkszz/mzdzg">本科生思想政治理论课</a></li>
								<li><a href="<?php bloginfo('wpurl');?>/yjszz/zgts">研究生思想政治理论课</a></li>
							</ul>
						</li>
					</ul>
				</li>
				<li>
					<ul>
						...
						<li>
							<ul>
								<li><a href="<?php bloginfo('wpurl');?>/zths">湖南省中国特色社会主义理论体系研究中心<br/><font style="margin-left:5em">湖南商学院基地</font></a></li>
				...
				<li>
					<ul>
						...
						<li>
							<ul>
								<li><a href="<?php bloginfo('wpurl');?>/hszt"><font style="margin-left:6em">湖南商学院</font><br/>大学生中国特色社会主义理论体系研究协会</a></li>
